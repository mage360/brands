...
class Uploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH    = 'mage360_brands/tmp/brands/image';
    /**
     * @var string
     */
    const IMAGE_PATH        = 'mage360_brands/brands/image';
    /**
     * @var string
     */
    const FILE_TMP_PATH     = 'mage360_brands/tmp/brands/file';
    /**
     * @var string
     */
    const FILE_PATH         = 'mage360_brands/brands/file';
